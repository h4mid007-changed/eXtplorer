...
class jx_ftp_authentication {
	...
	simple.add(
	    new Ext.form.TextField({
	        fieldLabel: '<?php echo $GLOBALS["messages"]["ftp_login_name"] ?>',
	        name: 'ftp_login_name',
	        width:175,
	        allowBlank:false
	    }),
	    new Ext.form.TextField({
	        fieldLabel: '<?php echo $GLOBALS["messages"]["ftp_login_pass"] ?>',
	        name: 'ftp_login_pass',
	        inputType: 'password',
	        width:175,
	        allowBlank:false
	    ...
	    new Ext.form.TextField({
	        fieldLabel: '<?php echo $GLOBALS["messages"]["ftp_hostname_port"] ?>',
	...
	simple.addButton('Save', function() {
	    simple.submit({
	        waitMsg: 'Probing Login, please wait...',
	        //reset: true,
	        reset: false,
