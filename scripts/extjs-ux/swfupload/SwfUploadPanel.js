 ...
 */
 Ext.define('Ext.ux.SwfUploadPanel.File', {
    ...
    initComponent: function() {
       var grid = this; 
        ...
        this.store = Ext.create("Ext.data.Store", {
			...
			model: "Ext.ux.SwfUploadPanel.File"
        });
        ...
        this.columns = [{
            ...
            width: 80, 
            dataIndex: 'status', 
            renderer: Ext.bind( this.formatStatus, this )
        }];
...
//            width: this.width - 7
        ...
        {	
        	...
        	items: [{
                ...
                itemId: 'swfuploadpanel-add-button',
                xhandler: function() {
                ...
                itemId: 'swfuploadpanel-cancel-button',
                ...
                itemId: 'swfuploadpanel-upload-button',
                ...
                itemId: 'swfuploadpanel-clear-button',
    ...
    myInit: function() {
        ...
        this.addBtn = tb.getComponent(0);
        this.cancelBtn = tb.getComponent('swfuploadpanel-cancel-button');
        this.uploadBtn = tb.getComponent('swfuploadpanel-upload-button');
        this.clearBtn = tb.getComponent('swfuploadpanel-clear-button');
        this.on('resize', this.resizeProgressBar, this);
        var suoID = Ext.id();
        var em = this.addBtn.getEl().child('em');
        em.setStyle({
            position: 'relative',
            display: 'block'
        });
        ...
        this.suo = new SWFUpload({
            ...
            swfupload_loaded_handler: Ext.bind( this.swfUploadLoaded, this),
    
            file_dialog_start_handler: Ext.bind(this.fileDialogStart, this),
            file_queued_handler: Ext.bind(this.fileQueue, this),
            file_queue_error_handler: Ext.bind(this.fileQueueError, this),
            file_dialog_complete_handler: Ext.bind(this.fileDialogComplete, this),
            
            upload_start_handler: Ext.bind(this.uploadStart, this),
            upload_progress_handler: Ext.bind(this.uploadProgress, this),
            upload_error_handler: Ext.bind(this.uploadError, this),
            upload_success_handler: Ext.bind(this.uploadSuccess, this),
            upload_complete_handler: Ext.bind(this.uploadComplete, this),
    ...
    resizeProgressBar: function() {
        if (this.progress_bar.el && this.getDockedItems('toolbar[dock="bottom"]')); {
            this.progress_bar.setWidth(this.getDockedItems('toolbar[dock="bottom"]')[0].getEl().getWidth() - 5);
            ...
            case -100: 
                ...
                switch(message) {
                    ...
                    case '1':
                        ...
                        break;
                    default:
                        slots = Ext.String.format(this.strings.error_queue_slots_2, message);
                }
                Ext.MessageBox.alert(this.strings.text_error, Ext.String.format(this.strings.error_queue_exceeded + ' ' + slots, this.file_queue_limit));
                break;
                
            case -110:				
               Ext.MessageBox.alert(this.strings.text_error, Ext.String.format(this.strings.error_size_exceeded, this.formatBytes( parseInt(this.file_size_limit) )));
                break;
    ...
    uploadProgress: function(file, bytes_completed, bytes_total) {
        ...
        this.progress_bar.updateProgress(bytes_completed/bytes_total, Ext.String.format(this.strings.text_uploading, file.name, this.formatBytes(bytes_completed), this.formatBytes(bytes_total)));
